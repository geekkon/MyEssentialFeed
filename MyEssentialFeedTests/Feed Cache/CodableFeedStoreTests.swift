...
private extension CodableFeedStoreTests {
    ...
    func expect(
        ...
        sut.retrieve { retievedResult in
            switch (expectedResult, retievedResult) {
                case (.empty, .empty),
                     (.failure, .failure):
                    break
                ...
                default:
                    XCTFail("Expected to retrieve \(expectedResult), got \(retievedResult) instead", file: file, line: line)
